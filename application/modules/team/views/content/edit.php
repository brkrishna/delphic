...
<div class='admin-box'>
    ...
    <?php echo form_open_multipart($this->uri->uri_string(), 'class="form-inline"'); ?>
        <fieldset>
            ...
            <!--<div class="control-group<?php echo form_error('profile_id') ? ' error' : ''; ?>">
                <?php echo form_label(lang('team_field_profile_id') . lang('bf_form_label_required'), 'profile_id', array('class' => 'control-label')); ?>
                <div class='controls'>
                    <input id='profile_id' type='text' required='required' name='profile_id'  value="<?php echo set_value('profile_id', isset($team->profile_id) ? $team->profile_id : ''); ?>" />
                    <span class='help-inline'><?php echo form_error('profile_id'); ?></span>
                </div>
            </div>-->
            <div class="row">
                <div class="span4">
                    ...
                    <div class="control-group<?php echo form_error('contact_nbr') ? ' error' : ''; ?>">
                        ...
                        <div class='controls'>
                            <input tabindex='4' id='contact_nbr' type='text' name='contact_nbr' maxlength='255' value="<?php echo set_value('contact_nbr', isset($team->contact_nbr) ? $team->contact_nbr : ''); ?>" />
                ...
                <div class="span4">
                    ...
                    <div class="control-group<?php echo form_error('profile') ? ' error' : ''; ?>">
                        ...
                        <div class='controls'>
                            <?php echo form_textarea(array('tabindex'=>'11', 'name' => 'profile', 'id' => 'profile', 'rows' => '5', 'cols' => '80', 'value' => set_value('profile', isset($team->profile) ? $team->profile : ''))); ?>
                ...
                <div class="span4">
                    <div class="control-group<?php echo form_error('dob') ? ' error' : ''; ?>">
                        ...
                        <div class='controls'>
                            <input id='dob' type='text' name='dob' maxlength='255' value="<?php echo set_value('dob', isset($team->dob) ? $team->dob : ''); ?>" tabindex='3' />
                    ...
                    <div class="control-group<?php echo form_error('attachment') ? ' error' : ''; ?>">
                        ...
                        <div class='controls'>
                            ...
                            <?php endif; ?>
                            <input tabindex='12' id='attachment' type='file' name='attachment' maxlength='4000' value="<?php echo set_value('attachment', isset($team->attachment) ? $team->attachment : ''); ?>" />
        ...
        <fieldset class='form-actions'>
            <input type='submit' name='save' class='btn btn-primary' value="<?php echo lang('team_action_create'); ?>" />
            <?php echo lang('bf_or'); ?>
            <?php echo anchor(SITE_AREA . '/content/team', lang('team_cancel'), 'class="btn btn-warning"'); ?>
