...
class Migration_Install_team_permissions extends Migration
{
	...
	private $permissionValues = array(
		array(
			'name' => 'Team.Content.View',
			'description' => 'View Team Content',
			'status' => 'active',
		),
		array(
			'name' => 'Team.Content.Create',
			'description' => 'Create Team Content',
			'status' => 'active',
		),
		array(
			'name' => 'Team.Content.Edit',
			'description' => 'Edit Team Content',
			'status' => 'active',
		),
		array(
			'name' => 'Team.Content.Delete',
			'description' => 'Delete Team Content',
			'status' => 'active',
		),
    );
