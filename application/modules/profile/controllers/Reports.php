...
{
    protected $permissionCreate = 'Profile.Reports.Create';
    protected $permissionDelete = 'Profile.Reports.Delete';
    protected $permissionEdit   = 'Profile.Reports.Edit';
    protected $permissionView   = 'Profile.Reports.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/reports/profile/index') . '/';
