        ...
        <fieldset>
            <div class="col-md-5">
                ...
                <div class="control-group<?php echo form_error('contact_number') ? ' error' : ''; ?>">
                    ...
                    <div class='controls'>
                        <input id='contact_number' type='text' required='required' name='contact_number' maxlength='50' value="<?php echo set_value('contact_number', isset($profile->contact_number) ? $profile->contact_number : ''); ?>" tabindex='4'/>
                ...
                <div class="control-group<?php echo form_error('post_code') ? ' error' : ''; ?>">
                    ...
                    <div class='controls'>
                        <input id='post_code' type='text' name='post_code' maxlength='10' value="<?php echo set_value('post_code', isset($profile->post_code) ? $profile->post_code : ''); ?>" tabindex='7'/>
                ...
                <div class="control-group<?php echo form_error('regn_nbr') ? ' error' : ''; ?>">
                    ...
                    <div class='controls'>
                        <input id='regn_nbr' type='text' name='regn_nbr' maxlength='255' value="<?php echo set_value('regn_nbr', isset($profile->regn_nbr) ? $profile->regn_nbr : ''); ?>" tabindex='9'/>
            ...
            <div class="col-md-5">
                <div class="control-group<?php echo form_error('address') ? ' error' : ''; ?>">
                    ...
                    <div class='controls'>
                        <?php echo form_textarea(array('name' => 'address', 'id' => 'address', 'rows' => '8', 'cols' => '80', 'value' => set_value('address', isset($profile->address) ? $profile->address : ''), 'required' => 'required', 'tabindex'=>'10')); ?>
