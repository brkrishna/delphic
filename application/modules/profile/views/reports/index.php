...
$num_columns	= 17;
$can_delete	= $this->auth->has_permission('Profile.Reports.Delete');
$can_edit		= $this->auth->has_permission('Profile.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/profile/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->entity_type); ?></td>
				<?php else : ?>
