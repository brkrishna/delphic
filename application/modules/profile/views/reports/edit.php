    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('entity_name') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <input id='entity_name' type='text' class="form-control" required='required' name='entity_name' maxlength='255' value="<?php echo set_value('entity_name', isset($profile->entity_name) ? $profile->entity_name : ''); ?>" />
