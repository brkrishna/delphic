...
class Migration_Install_style_permissions extends Migration
{
	...
	private $permissionValues = array(
		array(
			'name' => 'Style.Content.View',
			'description' => 'View Style Content',
			'status' => 'active',
		),
		array(
			'name' => 'Style.Content.Create',
			'description' => 'Create Style Content',
			'status' => 'active',
		),
		array(
			'name' => 'Style.Content.Edit',
			'description' => 'Edit Style Content',
			'status' => 'active',
		),
		array(
			'name' => 'Style.Content.Delete',
			'description' => 'Delete Style Content',
			'status' => 'active',
		),
    );
