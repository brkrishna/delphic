        ...
        <fieldset>
			...
			<?php 
                if (is_array($teams_select) && count($teams_select)) :
				    echo form_dropdown(array('id'=>'team', 'name'=>'team'), $teams_select, set_value('team', isset($registration_team->team) ? $registration_team->team : ''), 'Team'. lang('bf_form_label_required'), "tabindex='1'");
                endif;
			?>
