...
class Event_registration_model extends BF_Model
{
	...
	protected $validation_rules 		= array(
		array(
			'field' => 'profile_id',
			'label' => 'lang:event_registration_field_profile_id',
			'rules' => '',
		),
		array(
			'field' => 'event_id',
			'label' => 'lang:event_registration_field_event_id',
			'rules' => 'required',
		),
		array(
			'field' => 'category',
		...
		array(
			'field' => 'member_id',
			'label' => 'lang:event_registration_field_member_id',
			'rules' => '',
		),
		array(
			'field' => 'comments',
			'label' => 'lang:event_registration_field_comments',
